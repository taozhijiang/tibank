...
{
  long long int  Length;		/* Message length in bits      */
  unsigned int Intermediate_Hash[SHA1_HASH_SIZE/4]; /* Message Digest  */
...
int sha1_input(SHA1_CONTEXT*, const unsigned char *, unsigned int);
int sha1_result(SHA1_CONTEXT* , unsigned char Message_Digest[SHA1_HASH_SIZE]);
